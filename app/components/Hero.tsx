...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container-custom text-center px-4 pt-8 md:pt-12">
        {/* Content */}
        <div className="space-y-6 md:space-y-8 animate-fade-in-up">
          ...
          <div className="flex items-center justify-center gap-4 pt-4">
            <a
              ...
              className="p-3 rounded-full border border-border hover:border-primary/40 hover:bg-gradient-to-br hover:from-primary/10 hover:to-accent/10 transition-all group"
              aria-label="Email"
            >
              <svg
                className="w-5 h-5 group-hover:scale-110 transition-transform text-muted-foreground group-hover:text-primary"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
