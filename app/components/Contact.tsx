        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="glass-card p-6 md:p-8 rounded-2xl glow-effect animate-fade-in-up">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              ...
              >
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center border border-primary/20 shrink-0 group-hover:scale-110 transition-transform">
                  <svg
                ...
                <div>
                  ...
                  <p className="font-medium text-primary group-hover:text-accent transition-colors">{personalInfo.email}</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium text-primary group-hover:text-accent transition-colors">{personalInfo.phone}</p>
                </div>
              </a>
            </div>
